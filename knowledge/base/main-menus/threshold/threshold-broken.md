...
| 項目 | 内容 |
|---|---|
| Applicable Phase | B〜C |
| Zone | EN3 |
| Target distance range | 1600〜2400m main; session 3200〜4500m |
| Pattern name | 4 × (4×100m) at T-Pace |
...
|---|---|---|---|
| Prep | 8 × 50m 25 drill/25 swim | EN1〜EN2 | catch 作り |
| Main | 4 × (4 × 100m T-Pace @ 1:30) with 1:00 between rounds | EN3 | 高密度閾値 |
| Reset | 100m easy after round 2 if needed | EN1 | 品質維持 |
| Finish | 4 × 25m smooth fast | EN3 controlled | 速度接続 |
...
- 短い反復で pace を揃えやすい形式。
- round 間休息が長すぎると目的が変わります。
- 失敗が増える場合は 3 rounds。

## Variants

- **Short-course**: @1:30 は例。
- **Long-course**: 100m repeats with 15s rest。
- **Junior-friendly**: 3 × (4 × 75m)。
