...
| Pattern name | 8 × 200m at T-Pace @ 3:00 |
...
|---|---|---|---|
| Prep | 6 × 50m build | EN2〜EN3 | 閾値感覚 |
| Main | 8 × 200m Free Hold T-Pace @ 3:00 or 15s rest | EN3 | 乳酸閾値 |
| Reset | 4 × 50m easy/back | EN1 | フォーム回復 |
| Optional | 4 × 100m pull T-Pace +2s/100 | EN2〜EN3 | 上半身持久 |
...
- T-Pace は現状に合わせます。
- 1〜2本目が速すぎると失敗しやすいです。
- RPE が高すぎる場合は cycle を延ばします。

## Variants

- **Short-course**: @3:00 は例。
- **Long-course**: 15〜20s rest-based。
- **Junior-friendly**: 10 × 100m T-Pace。
