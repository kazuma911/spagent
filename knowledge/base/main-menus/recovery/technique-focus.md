...
| Zone | EN1 |
| Target distance range | 1500〜2500m session |
| Pattern name | heavy drill day, low intensity, high technique |
...
|---|---|---|---|
| Warm | 300〜600m easy | EN1 | 準備 |
| Skill | 12 × 50m drill/swim by 25m | EN1 | 技術反復 |
| Main | 8 × 100m smooth swim with one cue | EN1〜EN2 low | 泳ぎへ転移 |
| Cool | 200〜400m easy | EN1 | 回復 |
...
- 修正テーマは1〜2個に絞ります。
- 疲労が強い日は main を短縮できます。
- 観察時間を確保しやすい形式です。

## Variants

- **Short-course**: 25m drill。
- **Long-course**: 50m drill で観察。
- **Junior-friendly**: game-like cue を使う。
