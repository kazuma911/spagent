...
| Pattern name | 1500〜2500m easy free/back mix with drills |
...
|---|---|---|---|
| Warm | 400m easy swim | EN1 | ほぐす |
| Drill | 8 × 50m choice drill/swim | EN1 | 水感 |
| Main | 3 × 400m Free/Back mix, 30s rest | EN1 | 低強度循環 |
| Finish | 200m easy kick or swim | EN1 | 軽く終了 |
...
- 高強度翌日や taper 中に使います。
- RPE は低く会話できる強度。
- time target を置かず軽さを観察。

## Variants

- **Short-course**: 50m drill mix。
- **Long-course**: 長い easy swim。
- **Junior-friendly**: 1200〜1800m。
