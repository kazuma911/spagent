...
| 項目 | 内容 |
|---|---|
| Applicable Phase | A〜C |
| Zone | EN2〜EN3 |
| Target distance range | 1600m main; session 2800〜4000m |
| Pattern name | 100/200/300/400/300/200/100 ladder |
...
|---|---|---|---|
| Prep | 4 × 100m build | EN2 | 準備 |
| Main | 100/200/300/400/300/200/100m | Up EN2, Down to EN3 | 持久と変化 |
| Rule | Descending side gets faster by effort, not sprint | EN2〜EN3 | 制御 |
| Recovery | 300m easy | EN1 | 回復 |
...
- 距離変化で集中を保ちやすいです。
- 下りで上げすぎると sprint 化します。
- Phase A は全体 EN2、Phase C は下り EN3。

## Variants

- **Short-course**: 距離管理が簡単。
- **Long-course**: 100m単位で同じ。
- **Junior-friendly**: 50/100/150/200/150/100/50。
