...
| Applicable Phase | C |
| Zone | EN1〜SP3 |
| Target distance range | 1200〜2200m quality; session 2500〜4000m |
| Pattern name | full warm-up + 200/100/200 broken race pace + full cool-down |
...
|---|---|---|---|
| Warm | 800〜1200m race-day style warm-up | EN1〜SP2 touch | 試合準備 |
| Main 1 | Broken 200 as 4 × 50m, 15s rest | SP2 race pace | 200m配分 |
| Main 2 | Broken 100 as 4 × 25m, 10s rest | SP3 | 速度確認 |
| Main 3 | Broken 200 negative split | SP2 | 後半再現 |
| Cool | 600m easy | EN1 | 回復 |
...
- C期の重要 set として前後の疲労管理が必要。
- D期は量を半分程度にします。
- 実在大会名は使わず generic race scenario。

## Variants

- **Short-course**: turn込み確認。
- **Long-course**: rest 長め。
- **Junior-friendly**: Broken 100 + Broken 50。
