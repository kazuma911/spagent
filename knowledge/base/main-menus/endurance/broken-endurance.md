...
| Zone | EN2 |
| Target distance range | 1600〜2400m main; session 3000〜4500m |
| Pattern name | 4 × 400m at EN2 with short rest |
...
|---|---|---|---|
| Prep | 6 × 50m Free drill/swim | EN1〜EN2 | 長い軸 |
| Main | 4 × 400m Free @ 6:00〜7:00 or 20s rest | EN2 steady | 有酸素持久 |
| Pace check | 8 × 50m @ 1:00 | EN2 hold split | 後半安定 |
| Optional | 200m pull easy | EN1 | 距離追加 |
...
- Continuous より管理しやすくグループ練習向きです。
- 各400mの最初100mを抑えるよう cue します。
- 疲労が強い日は 3 × 400m にします。

## Variants

- **Short-course**: turn quality も観察。
- **Long-course**: rest-based 20s 推奨。
- **Junior-friendly**: 8 × 200m EN2。
