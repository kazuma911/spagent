# Mixed Stroke Aerobic 8×200 / 種目ミックス有酸素
...
| 項目 | 内容 |
|---|---|
| Applicable Phase | A〜B |
| Zone | EN1〜EN2 |
| Target distance range | 1200〜2000m main; session 2500〜4000m |
| Pattern name | 8 × 200m rotating IM at EN2 |
...
|---|---|---|---|
| Prep | 4 × 100m IM drill mix | EN1 | 各泳法確認 |
| Main | 8 × 200m as IM order or 50 stroke/150 free | EN2, 15〜25s rest | 多種目有酸素 |
| Skill | 4 × 50m choice drill | EN1 | 苦手種目確認 |
| Optional | 4 × 25m smooth build | EN2 | 接続 |
...
- 単一泳法の過負荷を避けます。
- Fly が崩れる選手は drill or 25m fly + free にします。
- ルールより動作品質を優先します。

## Variants

- **Short-course**: IM by 50m。
- **Long-course**: 100m単位で Free/Back 多め。
- **Junior-friendly**: 12 × 100m stroke/free by 50m。
