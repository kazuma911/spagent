...
| Zone | SP2〜SP3 |
| Target distance range | 500〜1000m main; session 2000〜3000m |
| Pattern name | USRPT 20×25m, 10s rest, miss-3-out |
...
|---|---|---|---|
| Prep | 8 × 25m build to race tempo | EN2〜SP2 | 準備 |
| Main | 20 × 25m target race pace, 10s rest | SP2〜SP3 | race pace 反復 |
| Rule | Miss target 3 times -> stop or switch easy | Quality control | 失敗反復回避 |
| Recovery | 400m easy choice | EN1 | 回復 |
...
- USRPT は target の明確さが重要です。
- race pace 不明なら保守的に設定します。
- 混雑時は安全に実施しにくいです。

## Variants

- **Short-course**: 25m 単位で実施。
- **Long-course**: 25m from mid-pool。
- **Junior-friendly**: 12〜16 × 25m。
