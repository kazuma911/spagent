# Junior Annual（ジュニア年間育成型）

## 対象コーチ像

U15 を長期育成したいコーチ。大会は学習確認。

## ピークの数と配置

大ピークより学年全体の成長を重視。主要大会前のみ小ピーク。

## フェーズ配分

A を長く、B/C/D は短く。REC と技術期を多め。 Phase 定義は [Phase 判定](../../zone-phase-mapping.md#4-phase判定-rules) を参照します。
