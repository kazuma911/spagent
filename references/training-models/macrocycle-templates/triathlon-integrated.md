# Triathlon Integrated（トライアスロン統合型）

## 対象コーチ像

Swim/Bike/Run を統合して見るコーチ。

## ピークの数と配置

シーズンピーク 1 つ、準備レース 1-2 回。

## フェーズ配分

A=6-8週、B=6週、C=3-4週、D=1-2週。Bike/Run と調整。 Phase 定義は [Phase 判定](../../zone-phase-mapping.md#4-phase判定-rules) を参照します。
