# Four Peaks Annual（年間 4 山型）

## 対象コーチ像

春・夏・秋・冬の記録会を楽しむ社会人や経験重視チーム。

## ピークの数と配置

年間 4 つの中ピーク。各ピーク後に短い REC。

## フェーズ配分

各山は A=3-4週、B=3週、C=1-2週、D=1週。 Phase 定義は [Phase 判定](../../zone-phase-mapping.md#4-phase判定-rules) を参照します。
