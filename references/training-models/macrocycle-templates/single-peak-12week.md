# Single Peak 12week（単発試合 12 週集中型）

## 対象コーチ像

年 1 回または半期 1 回の主要大会に集中したいコーチ。
...
A=4週、B=4週、C=2週、D=1-2週、REC=大会後。 Phase 定義は [Phase 判定](../../zone-phase-mapping.md#4-phase判定-rules) を参照します。
