...
ミトコンドリア系、有酸素代謝、リズム維持を刺激する。 評価はタイム、RPE、フォーム、回復の 4 点で行います。

## 代表セット例

| Set | 内容 | Target |
|---|---|---|
| 1 | 1×1500 steady EN2 | 主目的を維持 |
| 2 | 3×800 pull/swim @ EN2 | ペース再現 |
| 3 | 3 rounds: 6×25 quality + 200 easy | 短縮/応用 |

## 適用フェーズ

Phase A/REC。詳細は [Phase × Method](../../phase-method-mapping.md) を参照します。

## 適用対象

基礎作り、復帰期、Triathlon、健康維持。

## 注意点

単調化を避け Drill や変化を入れる。
