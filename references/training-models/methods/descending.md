# Descending Sets（段階上げ）

## 概要

本数やラウンドごとに徐々にペースを上げる。
...
ペース感覚、後半加速、終盤集中、神経系切替を養う。 評価はタイム、RPE、フォーム、回復の 4 点で行います。

## 代表セット例

| Set | 内容 | Target |
|---|---|---|
| 1 | 4×100 descend 1-4 @ 1:40 | 主目的を維持 |
| 2 | 8×50 descend by 4 @ 1:00 | ペース再現 |
...
ほぼ全対象。Junior/Masters のペース学習に有効。
