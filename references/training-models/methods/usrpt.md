...
25m/50m の超短距離を Race Pace で反復し、未達が続いたら終了する。
...
Race Pace での神経筋協調、速度維持、ターン後再加速を学習する。 評価はタイム、RPE、フォーム、回復の 4 点で行います。

## 代表セット例

| Set | 内容 | Target |
|---|---|---|
| 1 | 20×25 Free @ :35 target 100RP / 2 misses stop | 主目的を維持 |
| 2 | 16×50 @ 1:10 target 200RP | ペース再現 |
...
Sprint/100/200。Junior は少量。

## 注意点

Missed repeats とフォーム崩壊停止を守る。
