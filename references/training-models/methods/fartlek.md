...
有酸素を保ちながら速度変化、集中力、切替を刺激する。 評価はタイム、RPE、フォーム、回復の 4 点で行います。

## 代表セット例

| Set | 内容 | Target |
|---|---|---|
| 1 | 20×50 as 25 fast/25 easy | 主目的を維持 |
| 2 | 800 continuous every 4th 25 strong | ペース再現 |
| 3 | 3 rounds: 6×25 quality + 200 easy | 短縮/応用 |

## 適用フェーズ

A/REC。詳細は [Phase × Method](../../phase-method-mapping.md) を参照します。

## 適用対象

Masters、Junior、復帰期、単調さ回避。
