...
VO2max、心拍応答、乳酸耐性を刺激する。 評価はタイム、RPE、フォーム、回復の 4 点で行います。

## 代表セット例

| Set | 内容 | Target |
|---|---|---|
| 1 | 8×50 all-out @ 2:00 best average | 主目的を維持 |
| 2 | 4×(100 hard + 100 easy) @ 4:00 | ペース再現 |
| 3 | 3 rounds: 6×25 quality + 200 easy | 短縮/応用 |

## 適用フェーズ

Phase B/C。詳細は [Phase × Method](../../phase-method-mapping.md) を参照します。

## 適用対象

Masters の短時間刺激、Elite 高強度日、Triathlon 補助。

## 注意点

翌日疲労と Junior の技術崩れに注意。
