...
乳酸産生と除去の均衡、EN3 持続、後半耐性を作る。 評価はタイム、RPE、フォーム、回復の 4 点で行います。

## 代表セット例

| Set | 内容 | Target |
|---|---|---|
| 1 | 10×100 @ 1:30 T-pace+0-2s | 主目的を維持 |
| 2 | 5×200 @ 3:00 hold EN3 | ペース再現 |
| 3 | 3 rounds: 6×25 quality + 200 easy | 短縮/応用 |

## 適用フェーズ

Phase B。詳細は [Phase × Method](../../phase-method-mapping.md) を参照します。

## 適用対象

100 後半から 1500m、Masters、Triathlon、Elite。
