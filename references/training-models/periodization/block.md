...
2-4 週間ごとに主能力を絞り、Accumulation→Transmutation→Realization でピークへつなぐ。

## 由来

複数ピークや高度な適応を狙う現代競技スポーツで普及。

## 適用対象

年複数回大会がある Masters/Elite、短期集中で記録を狙うグループ。

## メニュー設計の含意

Accumulation は EN2、Transmutation は EN3/SP1、Realization は SP2/SP3 と taper。 Zone 配分は [Zone × Phase](../../zone-phase-mapping.md)、Method は [Phase × Method](../../phase-method-mapping.md) を参照します。
