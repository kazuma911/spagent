...
準備期で量を積み、試合期へ向けて量を下げ強度を上げる古典的モデル。年 1-2 回の主要大会に合わせやすい。

## 由来

1960 年代の旧ソ連スポーツ科学で整理された一般準備・専門準備・試合・移行の流れ。

## 適用対象

年 1 回の主要大会、基礎を作り直す Masters、年間の見通しを学ばせたい Junior。

## メニュー設計の含意

Phase A は EN1/EN2 と技術、B は EN3、C/D は SP1-SP3。曜日ごとの目的を固定しやすい。 Zone 配分は [Zone × Phase](../../zone-phase-mapping.md)、Method は [Phase × Method](../../phase-method-mapping.md) を参照します。
