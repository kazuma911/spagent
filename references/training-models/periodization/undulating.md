...
週内または日内で強度・量を波状に変える。限られた頻度でも複数能力に触れる。

## 由来

線形モデルの単調さを避ける非線形 periodization。

## 適用対象

週 2-3 回の Masters、不定期参加、Triathlon、飽きやすいグループ。

## メニュー設計の含意

high / medium / low を明確にし、高強度翌日は EN1/技術にする。 Zone 配分は [Zone × Phase](../../zone-phase-mapping.md)、Method は [Phase × Method](../../phase-method-mapping.md) を参照します。
